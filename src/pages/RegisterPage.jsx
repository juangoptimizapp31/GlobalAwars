            ...
            <div className="row justify-content-between">
              <div className="col-lg-12 col-12 d-flex">
                ...
                <ul className="social-icon d-flex justify-content-center align-items-center mx-auto">
                  <span className="text-white me-4 d-none d-lg-block">Registrate</span>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-12 col-12">
                      ...
                      <div className="form-check mb-4">
                        ...
                        <label className="form-check-label" htmlFor="flexCheckDefault">
                          Acepto terminos y condiciones de servicio y politica de privacidad
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="row justify-content-center align-items-center">
                      ...
                      <div className="col-lg-6 col-md-6 col-7">
                        <p className="mb-0">Ya tienes una cuenta? <Link to="/login" className="ms-2">Ingresar</Link></p>
                      </div>
                    </div>
                  </div>
                </form>
